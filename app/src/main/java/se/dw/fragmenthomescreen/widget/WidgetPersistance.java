 ...
 * Saves and Loads the widgets to shared preferences.
 */
public class WidgetPersistance {
    ...
    public static ArrayList<ItemInfo> getWidgets(int screenId) {
        String key = "widgetids-" + screenId;
    ...
    public static void setWidgets(int screenId, ArrayList<ItemInfo> widgets) {
        String key = "widgetids-" + screenId;
